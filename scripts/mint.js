...
const tokenArray = require("../metadata/metadata-array.json");
...
async function mintNFT(tokenURI) {
  ...
  const tx = {
    ...
    nonce: nonce,
    gas: 500000,
    data: nftContract.methods.mint(PUBLIC_KEY, 1, 0, 1).encodeABI(),
  };
  ...
  console.log("zzz3", signedTx);
  console.log("zzz4", transactionReceipt);
...
mintNFT(tokenArray[Math.floor(Math.random() * tokenArray.length)]);
